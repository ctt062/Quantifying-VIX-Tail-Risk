...
\begin{itemize}
    ...
    \item Box, G. E. P., \& Jenkins, G. M. (2015). \textit{Time Series Analysis: Forecasting and Control} (5th ed.). John Wiley \& Sons.
    ...
    \item Embrechts, P., Kl\"uppelberg, C., \& Mikosch, T. (1997). \textit{Modelling Extremal Events: For Insurance and Finance}. Springer.
    ...
    \item Hawkes, A. G. (1971). Spectra of some self-exciting and mutually exciting point processes. \textit{Biometrika}, 58(1), 83--90.
    ...
    \item Kwiatkowski, D., Phillips, P. C. B., Schmidt, P., \& Shin, Y. (1992). Testing the null hypothesis of stationarity against the alternative of a unit root: How sure are we that economic time series have a unit root? \textit{Journal of Econometrics}, 54(1-3), 159--178.
    ...
    \item Smirnov, N. V. (1948). Table for estimating the goodness of fit of empirical distributions. \textit{Annals of Mathematical Statistics}, 19(2), 279--281.
\end{itemize}
