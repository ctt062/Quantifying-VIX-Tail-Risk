...
\begin{center}
    \includegraphics[width=0.75\textwidth]{jump_distribution.png}
\end{center}
\begin{itemize}
...
\begin{center}
    \includegraphics[width=0.75\textwidth]{cpp_var.png}
\end{center}
\begin{itemize}
...
\begin{center}
    \includegraphics[width=0.9\textwidth]{shock_magnitudes.png}
\end{center}
\begin{itemize}
